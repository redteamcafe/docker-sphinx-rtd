...
RUN wget -P /tmp https://raw.githubusercontent.com/redteamcafe/docker-sphinx-rtd/main/autosphinx_start.sh
RUN chmod +x /tmp/autosphinx_start.sh
CMD ./tmp/autosphinx_start.sh
RUN echo "Done"
